                            ...
                            <v-container>
                                <v-row>
                                    <v-col cols="12" sm="6" md="6">
                                        <v-text-field :rules="[rules.required]" v-model="editedItem.name" label="Product Name"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6">
                                        <v-text-field :rules="[rules.required]" v-model="editedItem.description" label="Description"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="4">
                                        <v-text-field :rules="[rules.required]" v-model="editedItem.price" label="Price"></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="4">
                                    ...
                                    <v-col cols="12">
                                        <template>
                                            <v-file-input v-model="editedItem.img" label="File input" filled prepend-icon="mdi-camera"></v-file-input>
                                            <v-btn @click="upload(editedItem)">upload img</v-btn>
                                        </template>
                                    </v-col>
                                </v-row>
                            </v-container>
            ...
            axios
                ...
                .then(response => {
                    ...
                    this.products = products.map(product => ({
                        ...product,
                        status: product.status ? 'Avaliable' : 'Out of stock'
                    }));
                })
                .catch(error => {
                    console.log(error);
